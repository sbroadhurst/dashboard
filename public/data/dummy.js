...
export const gridOrderImage = (props) => (
  <div className="h-20 w-20">
    <Image className="rounded-xl md:ml-3" height={'80px'} width={'80px'} src={props.ProductImage} alt="order-item" />
  </div>
)
...
const gridEmployeeProfile = (props) => (
  <div className="flex items-center gap-2">
    <Image width={'40px'} height={'40px'} className="rounded-full" src={props.EmployeeImage} alt="employee" />
    <p>{props.Name}</p>
  </div>
)
...
const customerGridImage = (props) => (
  <div className="image flex gap-4">
    <Image height={'40px'} width={'40px'} className="rounded-full" src={props.CustomerImage} alt="employee" />
    <div>
...
export const rangeColorMapping = [
  ...
  { label: '11°C to 20°C', start: 11, end: 20, colors: ['#FFA500'] },

  { label: '21°C to 30°C', start: 21, end: 30, colors: ['#FF4040'] },
]
...
export const productsPerformance = [
  ...
  {
    image: product4,
    title: 'Stylish Nike Shoes for night',
...
export const ordersData = [
  ...
  },
  {
    ...
    TotalAmount: 93.31,
    OrderItems: 'Waffle Cone Ice Cream',
    Location: 'New York',
    Status: 'active',
    StatusBg: '#03C9D7',
